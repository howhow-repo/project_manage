...
from .views import list_materials, add_material, material_detail, material_type, del_material_type, delete_material
...
urlpatterns = [
    ...
    path("<str:material_name>/delete", delete_material, name='delete_material'),
